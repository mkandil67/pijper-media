...
@section('content')
    <div class="container-fluid border m-2 pt-3">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-6">
                        @foreach($posts as $post)
                            <div class="card shadow-sm m-1 mb-5 ">
                                ...
                                @endif
                                <span style="text-align: center">Written by you </span>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <form style="display: inline-flex;" action="{{route('posts', ['id' => $post->id, 'user' => $user->id])}}" method="POST" id="form">
                                            ...
                                            <button type="submit" class="btn btn-sm font-weight-bold">Remove</button>
                                        </form>
                                    </div>
                                </div>
