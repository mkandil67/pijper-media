                        ...
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-6 pt-5">
                            @foreach(App\Models\Post::where('writer_id','>',0)->where('updated_at', '>=', \Carbon\Carbon::now()->subHour())->get() as $post)
                                <div class="card shadow-sm m-1 mb-5 ">
                                    @if(strtolower(App\Models\Accounts::where('id','=',$post->account_id)->first()->platform) == 'facebook')
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <small class="text-muted">{{App\Models\Accounts::where('id','=',$post->account_id)->first()->category}}</small>
                                        </div>
                                        <div class="row">
                    ...
                    <div class="container-fluid" id="postsCard">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
                            @foreach(App\Models\Post::where('writer_id','=',null)->orderBy('posted_at','desc')->get() as $post)
                                @if($categories[App\Models\Accounts::where('id','=',$post->account_id)->first()->category] && strtolower(App\Models\Accounts::where('id','=',$post->account_id)->first()->platform)=='facebook')
                                    <div class="card shadow-sm m-1 mb-5 ">
